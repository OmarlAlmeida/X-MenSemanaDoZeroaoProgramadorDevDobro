...
personagens.forEach((personagem) => {
    personagem.addEventListener('mouseenter', () => {
        ...
        const idPersonagem2 = personagem.attributes.id.value;
        imagemlogo.src = `../src/imagens/logo-${idPersonagem}.png`;

        const imagemFundo = document.querySelector('.corpo');
        const idPersonagem3 = personagem.attributes.id.value;
        imagemFundo.src = `../src/imagens/bg-${idPersonagem}.jpg`;
